...
export declare class FournisseursController {
    ...
    update(idOrSlug: string, data: any): Promise<{
        '@id': string;
        firstName: string;
        lastName: string;
        email: string;
    ...
    getAbonnements(idOrSlug: string, order?: {
        [key: string]: string;
    }): Promise<{
        'hydra:member': {
            offre: {
    ...
    getBlackListes(idOrSlug: string, order?: {
        [key: string]: string;
    }): Promise<{
        'hydra:member': ({
            acheteur: {
    ...
    getJetons(idOrSlug: string, order?: {
        [key: string]: string;
    }): Promise<{
        'hydra:member': ({
            paiement: {
    ...
    getProduits(idOrSlug: string, page?: string, limit?: string, order?: {
        [key: string]: string;
    }): Promise<{
        'hydra:member': {
            isValid: boolean;
