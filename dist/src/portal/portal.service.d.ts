...
export declare class PortalService {
    ...
    getParcourirCategories(sousSecteurIdOrSlug: string): Promise<{
        id: number;
        name: string;
        slug: string;
        count: number;
    }[]>;
    countDemandesCategorie(secteurSlug?: string, sousSecteurSlug?: string, categorieSlug?: string): Promise<{
        id: number;
        name: string;
        slug: string;
        count: number;
